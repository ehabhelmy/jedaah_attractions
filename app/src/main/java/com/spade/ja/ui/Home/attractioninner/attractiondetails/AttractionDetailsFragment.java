...
public class AttractionDetailsFragment extends BaseFragment implements AttractionDetailsContract.View {

    @Inject
    AttractionDetailsPresenter presenter;
    ...
    protected int getLayoutId() {
        return R.layout.fragment_attraction_details;
    }
    ...
    public void setupAttractionDetails(Data data) {
        ...
        tagAdapter.setTags((ArrayList<EventTag>) data.getAttractionTags());
        tags.setAdapter(tagAdapter);
    }

    @OnClick(R.id.buyNow)
    void openBuyView(){
        presenter.openPaymentView();
    }
