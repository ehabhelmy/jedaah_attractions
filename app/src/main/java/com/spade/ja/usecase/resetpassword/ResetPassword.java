...
public class ResetPassword implements Unsubscribable {
    ...
    @Inject
    public ResetPassword(DataRepository dataRepository, CompositeDisposable compositeDisposable) {
        this.dataRepository = dataRepository;
        this.compositeDisposable = compositeDisposable;
    }

    public void resetPassword(String code,String password, BaseCallback<ContactUsResponse> callback) {
        ...
        if (!compositeDisposable.isDisposed()) {
            contactUsResponseSingle = dataRepository.resetPassword(password, code);
