...
public class EventCancel implements Unsubscribable {
    ...
    @Inject
    public EventCancel(DataRepository dataRepository, CompositeDisposable compositeDisposable) {
        this.dataRepository = dataRepository;
        this.compositeDisposable = compositeDisposable;
    }

    public void eventCancel(int id, BaseCallback<ContactUsResponse> callback) {
        ...
        if (!compositeDisposable.isDisposed()) {
            contactUsResponseSingle = dataRepository.cancelEvent(id);
