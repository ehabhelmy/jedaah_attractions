package com.spade.ja.usecase.filter.filtercatsdirectory;
...
public class FilterCatsDirectory implements Unsubscribable {
    ...
    @Inject
    public FilterCatsDirectory(DataRepository dataRepository, CompositeDisposable compositeDisposable) {
    ...
    public void filter(List<Integer> categoryId, BaseCallback<AllNearByResponse> filterEventsResponseBaseCallback) {
        ...
        if (!compositeDisposable.isDisposed()){
            filterEventsResponseSingle = dataRepository.filterCatsDirectories(categoryId);
