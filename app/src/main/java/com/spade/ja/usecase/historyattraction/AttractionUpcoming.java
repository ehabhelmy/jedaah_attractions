...
public class AttractionUpcoming implements Unsubscribable{
    ...
    @Inject
    public AttractionUpcoming(DataRepository dataRepository, CompositeDisposable compositeDisposable) {
        this.dataRepository = dataRepository;
        this.compositeDisposable = compositeDisposable;
    }

    public void getUpcomingAttractions(BaseCallback<AttractionOrderHistoryResponse> callback) {
        ...
        if (!compositeDisposable.isDisposed()) {
            historyEventsSingle = dataRepository.getUpcomingAttractions();
